const projects = [
  ...
  },
  {
    ...
    desc: 'A generative particle simulation blending orbital mechanics with aesthetic composition. Pure Three.js, no dependencies.',
    tags: ['Three.js', 'GLSL', 'WebGL', 'JavaScript'],
    accent: '#C084FC',
    icon: '🌌',
    github: '#',
    live: '#',
